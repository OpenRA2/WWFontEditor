namespace Nyerguds.Util.Ui
{
    ...
    /// </summary>
    /// <typeparam name="TInfoObject">The type of the info object. Can be chosen freely.</typeparam>
    public interface ListedControlController<in TInfoObject>
    {
        /// <summary>
        ...
        void UpdateControlInfo(TInfoObject updateInfo);
    }
}
