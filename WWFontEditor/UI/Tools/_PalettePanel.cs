...
namespace Nyerguds.Util.UI
{
    ...
    public partial class PalettePanel : UserControl
    {
        ...
        /// <summary>Disables the "feature" that double-clicking a label copies its text.</summary>
        protected class LabelNoCopyOnDblClick : Label
        {
            ...
            protected override void WndProc(ref Message m)
            {
                ...
                // Backup clipboard
                using (ClipboardBackup cb = new ClipboardBackup(true))
                {
                    // THIS MESSES UP THE CLIPBOARD
                    base.WndProc(ref m);
                    // Restore clipboard
                    cb.RestoreClipboard();
                }
